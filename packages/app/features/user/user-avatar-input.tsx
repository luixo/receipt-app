...
import { options as userChangeAvatarOptions } from "~mutations/user/change-avatar";
	...
	({ onClick }) => {
		...
		return (
			<Avatar
				hashId={user.id}
				image={
					user.avatarUrl ? { url: user.avatarUrl, alt: user.email } : undefined
				}
				onPress={onClick}
				size="lg"
...
export const UserAvatarInput: React.FC<Props> = ({ children }) => {
	...
	const updateAvatarMutation = useMutation(
		trpc.user.changeAvatar.mutationOptions(
			useTrpcMutationOptions(userChangeAvatarOptions, {
