	...
	test: {
		...
		coverage: {
			...
			exclude: [
				...
				path.resolve(rootPath, "apps/web/src/pages/__root.tsx"),
				path.resolve(rootPath, "apps/web/src/pages/_protected.tsx"),
				path.resolve(rootPath, "apps/web/src/pages/_public.tsx"),
				path.resolve(rootPath, "apps/web/src/pages/index.tsx"),
				path.resolve(rootPath, "apps/web/src/pages/!(api)**/*"),
				path.resolve(rootPath, "apps/web/src/pages/api/coverage.ts"),
				path.resolve(rootPath, "apps/web/src/pages/api/ping.test.ts"),
				path.resolve(rootPath, "apps/web/src/pages/api/ping.ts"),
				path.resolve(rootPath, "apps/web/src/pages/api/test.utils.ts"),
				path.resolve(rootPath, "apps/web/src/pages/api/utils/cleanup.test.ts"),
				path.resolve(rootPath, "apps/web/src/pages/api/utils/cleanup.ts"),
				path.resolve(
					rootPath,
					"apps/web/src/pages/api/utils/ping-cache.test.ts",
				),
				path.resolve(rootPath, "apps/web/src/pages/api/utils/ping-cache.ts"),
