...
export const router = trpc
	...
	.merge("resetPasswordIntentions.", resetPasswordIntentionsRouter)
	.middleware(verifyAuthorizedMiddleware)
	.merge("account.", accountRouter)
	.merge("receipts.", receiptsRouter)
	.merge("receiptItems.", receiptItemsRouter)
	.merge("users.", usersRouter)
	.merge("receiptParticipants.", receiptParticipantsRouter)
	.merge("currency.", currencyRouter)
	.merge("itemParticipants.", itemParticipantsRouter)
	.merge("accountConnectionIntentions.", accountConnectionIntentionsRouter)
	.merge("debts.", debtsRouter)
	.merge("debtsSyncIntentions.", debtsSyncIntentionsRouter);
